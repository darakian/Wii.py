...
class BNS(object):
    ...
    def create_bns(self, inbuf, samplerate=44100, channels=2):
        ...
        if self.info.chan_cnt == 2:
            for x in range(16): self.info.coefficients2[x] = self.deftbl[x]
        return
